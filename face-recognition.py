...
def recognize_faces(embeddings) :
      ...
      for file in glob.glob("image_validation/*"):
          ...
          cv2.imwrite('image_output_1/image_{}.jpg'.format(a),image)
...
def load_embeddings() :
      input_embeddings = {}
      embedding_file = np.load('F:/project_ML/Face-recognize-with-Meta-learning/embeddings.npy',allow_pickle=True)
