...
def recognize_faces(embeddings) :
      ...
      # motified code for target
      a=0
      #cap = cv2.VideoCapture(0)
      for file in glob.glob("image_validation/*"):
          a +=1
          ...
          cv2.imwrite('image_output_5/image_{}.jpg'.format(a),image)
...
def load_embeddings() :
      input_embeddings = {}
      embedding_file = np.load('C:/Users/admin/Desktop/face-recognition-cnn-master/embeddings.npy',allow_pickle=True)
